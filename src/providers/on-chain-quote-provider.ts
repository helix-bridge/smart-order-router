...
import { encodeMixedRouteToPath, MixedRouteSDK, Protocol, } from '@helix-bridge/router-sdk';
import { ChainId } from '@helix-bridge/sdk-core';
import { encodeRouteToPath } from '@helix-bridge/v3-sdk';
...
import { ID_TO_NETWORK_NAME, isChainSupportedByHelixSwap, metric, MetricLoggerUnit } from '../util';
...
export class OnChainQuoteProvider implements IOnChainQuoteProvider {
  ...
  >(
    ...
    if (isChainSupportedByHelixSwap(this.chainId)) {
